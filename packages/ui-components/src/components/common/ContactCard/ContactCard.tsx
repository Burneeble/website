  ...
  return (
    <>
      ...
      <div
        ...
        className={`
          contact-card tw-inline-flex tw-h-[116px] tw-w-[424px] tw-items-center
          tw-justify-center tw-gap-[26px] tw-rounded-lg tw-border-2
          tw-bg-gradient-to-l tw-px-9 tw-py-[29px] secondary-gradient
      ...
      >
        ...
        >
          ...
          {width >= 768 && (
            ...
            >
              <p
                className={`
                  contact-card-title tw-self-stretch tw-text-start tw-font-inter
        ...
        <Button
          ...
          className={`
            ...
            tw-justify-center tw-gap-2.5 tw-self-stretch tw-rounded-lg tw-border
            tw-border-primary tw-bg-[#F28307] tw-px-[30px] tw-py-5
