...
const navigationMenuTriggerStyle = cva(
  `
    ...
    tw-rounded-md tw-px-4 tw-py-2 tw-font-inter tw-font-medium tw-text-body
    tw-bg-background tw-text-2xl tw-transition-colors

    data-[active]:tw-bg-accent/50

    data-[state=open]:tw-bg-accent/50

    disabled:tw-pointer-events-none disabled:tw-opacity-50

    focus:tw-bg-accent focus:tw-text-accent-foreground focus:tw-outline-none
    ...
    <NavigationMenuPrimitive.Viewport
      className={cn(
        `
          ...
          tw-overflow-hidden tw-rounded-md tw-border tw-bg-popover
          tw-text-popover-foreground tw-shadow
  ...
  return (
    <li>
      <NavigationMenuLink asChild>
        ...
        >
          <div
            className={`tw-font-inter tw-text-xl tw-font-medium tw-leading-none`}
          >
            {title}
          </div>
          <p
