...
const buttonVariants = cva(
  `
    tw-inline-flex tw-cursor-pointer tw-items-center tw-justify-center tw-gap-2
    tw-whitespace-nowrap tw-rounded-md tw-font-bowlby-one tw-text-lg
  ...
  `,
  {
    variants: {
      variant: {
        ...
        destructive: `
          tw-bg-button-error tw-bg-button-text tw-border tw-border-error
          tw-shadow
        `,
